...
## Link: https://datacarpentry.org/r-socialsci/
...
## 2) Before we Start
##    https://datacarpentry.org/r-socialsci/00-intro/index.html
## 3) Introduction to R
...
############## 1) Setup ####
# Visit https://datacarpentry.org/r-socialsci/
# Go to Setup or visit: https://datacarpentry.org/r-socialsci/setup.html

# R and RStudio should be installed

# After installing R and RStudio, install 
# the tidyverse and here packages

install.packages("tidyverse")
install.packages("here")


# Lesson uses SAFI_clean.csv. 
# The direct download link for this file is: 
...
############## 2) Introduction to R  ####
# Visit https://datacarpentry.org/r-socialsci/01-intro-to-r/index.html
